...
SWFUpload.prototype.initSettings = function() {
    ...
    if (!this.settings.preserve_relative_urls) {
        ...
        // SWFUpload.completeURL(this.settings.flash_url); // Don't need to do
        // this one since flash doesn't look at it
...
SWFUpload.prototype.destroy = function() {
    try {
        ...
        if (movieElement && typeof(movieElement.CallFunction) === "unknown") { // We
                                                                                // only
                                                                                // want
                                                                                // to
                                                                                // do
...
SWFUpload.prototype.displayDebugInfo = function() {
    this
            .debug( [
                            ...
                            (typeof this.settings.debug_handler === "function")
                                    .toString(), "\n"].join(""));
};
...
// Private: Called by Flash to see if JS can call in to Flash (test if External
...
// Private: removes Flash added fuctions to the DOM node to prevent memory leaks
// in IE.
