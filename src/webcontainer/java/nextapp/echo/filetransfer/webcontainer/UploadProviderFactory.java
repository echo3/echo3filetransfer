...
import nextapp.echo.filetransfer.webcontainer.impl.JakartaCommonsFileUploadProvider;

/**
 * Factory for <code>UploadSPI</code> implementations.
 * <p>
 * Custom <code>UploadSPI</code> implementations may be configured by calling
 * {@link #setUploadProvider(UploadSPI)} from within an application entry point.
 */
