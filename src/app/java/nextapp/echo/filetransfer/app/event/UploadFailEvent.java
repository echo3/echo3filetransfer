...
/**
 * An event indicating that a file upload has failed.
 */
public class UploadFailEvent extends UploadEvent {
	private Exception e;
	
	/**
	 * Creates a new <code>UploadFailedEvent</code>.
	 * 
     * @param source the source of the event
	 * @param index the index of the upload
	 */
	public UploadFailEvent(UploadSelect source, int index) {
		super(source, index);
	}
	 ...
	 * @param source the source of the event
	 * @param index the index of the upload
	 * @param e the exception that caused the file upload to fail
	 */
	public UploadFailEvent(UploadSelect source, int index, Exception e) {
		super(source, index);
		this.e = e;
	}
