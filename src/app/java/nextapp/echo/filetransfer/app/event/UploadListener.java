...
/**
 * A listener for file upload events. Any updates to the application user interface must be performed inside the user interface
 * thread, this can be done by enqueing a task.
 * 
 * @see ApplicationInstance#enqueueTask(nextapp.echo.app.TaskQueueHandle, Runnable)
 */
public interface UploadListener extends EventListener {
    ...
    /**
     * Indicates a file upload has failed.
     * 
     * @param e the event
     */
    ...
    /**
	 * Indicates a file upload has finished, use
	 * {@link UploadFinishEvent#getInputStream()} to obtain the contents.
	 * Implementations should take care of closing this stream, since it may
