...
/**
 * An event indicating that a file upload has been canceled.
 */
public class UploadCancelEvent extends UploadEvent {

	/**
	 * Creates a new <code>UploadCancelEvent</code>.
	 * 
     * @param source the source of the event
	 * @param index the index of the upload
	 */
	public UploadCancelEvent(UploadSelect source, int index) {
		super(source, index);
	}
}