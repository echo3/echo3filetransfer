...
public class TestPane extends ContentPane {
    ...
    private ActionListener commandActionListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                startTest(e.getActionCommand());
        }
    };
    
    public void startTest(String testName) {
        try {
            Class screenClass = getScreenClass(testName);
    ...
    public TestPane(String initialTest) {
        super();
        ...
        addTest("Multiple Upload Select", "MultipleUploadSelectTest");
    ...
    private Class getScreenClass(String testName) {
        try {
            return Class.forName("nextapp.echo.filetransfer.testapp.testscreen." + testName);
