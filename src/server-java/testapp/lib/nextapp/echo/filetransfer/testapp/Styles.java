...
public class Styles {
    ...
    public static final String IMAGE_PATH = "nextapp/echo/filetransfer/testapp/resource/image/";
    public static final String STYLE_PATH = "nextapp/echo/filetransfer/testapp/resource/style/";
    
    public static final ImageReference ICON_64_ERROR
            = new ResourceImageReference(IMAGE_PATH + "Icon64Error.gif");
    public static final ImageReference ICON_64_INFORMATION
            = new ResourceImageReference(IMAGE_PATH + "Icon64Information.gif");
    public static final ImageReference ICON_64_QUESTION
            = new ResourceImageReference(IMAGE_PATH + "Icon64Question.gif");
    public static final ImageReference ICON_64_WARNING
            = new ResourceImageReference(IMAGE_PATH + "image/Icon64Warning.gif");
