...
/**
 * Synchronization peer for the  {@link UploadSelect} component.
 */
public class UploadSelectPeer extends AbstractUploadSelectPeer {

    private static final Service SERVICE = JavaScriptService.forResources("FileTransfer.UploadSelect",
            new String[] { 
                "nextapp/echo/filetransfer/webcontainer/resource/Application.UploadSelect.js", 
                "nextapp/echo/filetransfer/webcontainer/resource/Sync.UploadSelect.js" 
            });
